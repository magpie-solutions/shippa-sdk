...
class Fedex extends Shipment
{
    ...
    public function testShipmentResponseSuccess()
    {
        ...
        return '{"status":"ok","code":200,"tracking_number":"' . $tracking . '","pickup_confirmation":"' . $tracking . '","origin_service_area":"LBA","pickup_location":"LBAC","output":{"transactionId":"51d6ca36-8210-468a-8dac-3afb91f89986","output":{"pickupConfirmationCode":"3072","location":"LBAC"}}}';
    }
