...
class Dhl extends Shipment
{
    ...
    public function testShipmentResponseSuccess()
    {
        ...
        return '{"status":"ok","code":200,"tracking_number":"TST' . $tracking . '","origin_service_area":"LBA"}';
    }
